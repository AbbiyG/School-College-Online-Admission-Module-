                ...
                <div class="col-md-4">
                    <div class="logo">
                        ...
                        <i class="fa fa-graduation-cap"  style="font-size: 22px;"></i>
                            <span>Admission <span id="na"></span></span>
                        </a>
                    </div>
                </div>
    <!--================== Main menu-area ====================-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="widget">
                        <div class="logo">
                            ...
                            <p> It is a simple insert, view, delete, update project in PHP with mysql database. It's full secured and with proper form validation.
                                 Here I create a form as student admission form to insert student information,
                                 and display the all students information in view page. I also add here delete and update option.
                    ...
                    <div class="widget">
                        ...
                        <div class="footer-menu">
                            <ul>
                                ...
                                <li><a href="https://www.facebook.com/Abbiygautam">contact us</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <h3>Contact Us</h3>
                    <span class="social-icon">
                        <a href="https://www.facebook.com/Abbiygautam"><i class="fa fa-facebook"></i></a>
                        <a href="https://mail.google.com/mail/u/0/#inbox"><i class="fa fa-google-plus"></i></a>
                    </span>
                </div>
                <p class="copy-right">Design & Development by <a href="https://www.facebook.com/Abbiygautam">Abbiy Gautam</a>  Copyright By <a href = "https://www.youtube.com/@Ogmustafa">Abbiy Gautam</a>
